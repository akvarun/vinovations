...
import cylinder_proto from '../../../../public/images/cylinder_proto.jpg';
import cylinder_hd from '../../../../public/images/cylnder_hd.jpeg';
import {
    ...
    <Wrapper>
      <Inner>
        ...
        <BannerCtn>
          ...
          >
            {isMobile ? (
              <Image src={cylinder_hd} alt="banner_img" fill />
            ) : (
              <Image src={cylinder_hd} alt="banner_img" fill />
            )}
          </Div>
